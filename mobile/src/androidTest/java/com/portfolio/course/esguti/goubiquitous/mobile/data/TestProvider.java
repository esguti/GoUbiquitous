 ...
 */
package com.portfolio.course.esguti.goubiquitous.mobile.data;
...
import com.portfolio.course.esguti.goubiquitous.mobile.data.WeatherContract.LocationEntry;
import com.portfolio.course.esguti.goubiquitous.mobile.data.WeatherContract.WeatherEntry;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        // content://com.portfolio.course.esguti.goubiquitous.mobile/weather/
        String type = mContext.getContentResolver().getType(WeatherEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.portfolio.course.esguti.goubiquitous.mobile/weather
        assertEquals("Error: the WeatherEntry CONTENT_URI should return WeatherEntry.CONTENT_TYPE",
                WeatherEntry.CONTENT_TYPE, type);

        String testLocation = "94074";
        // content://com.portfolio.course.esguti.goubiquitous.mobile/weather/94074
        ...
        // content://com.portfolio.course.esguti.goubiquitous.mobile/weather/94074/20140612
        type = mContext.getContentResolver().getType(
                WeatherEntry.buildWeatherLocationWithDate(testLocation, testDate));
        // vnd.android.cursor.item/com.portfolio.course.esguti.goubiquitous.mobile/weather/1419120000
        assertEquals("Error: the WeatherEntry CONTENT_URI with location and date should return WeatherEntry.CONTENT_ITEM_TYPE",
                WeatherEntry.CONTENT_ITEM_TYPE, type);

        // content://com.portfolio.course.esguti.goubiquitous.mobile/location/
        type = mContext.getContentResolver().getType(LocationEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.portfolio.course.esguti.goubiquitous.mobile/location
