...
public class MainActivity extends AppCompatActivity implements ForecastFragment.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // our fake server. Because weather alerts are not a core feature of the com.portfolio.course.esguti.goubiquitous.mobile, this should
        // not affect the behavior of the com.portfolio.course.esguti.goubiquitous.mobile, from a user perspective.
        if (checkPlayServices()) {
            // Because this is the initial creation of the com.portfolio.course.esguti.goubiquitous.mobile, we'll want to be certain we have
