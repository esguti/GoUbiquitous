...
import com.portfolio.course.esguti.goubiquitous.mobile.muzei.WeatherMuzeiSource;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APPID_PARAM,
                            getContext().getString(R.string.OPEN_WEATHER_MAP_API_KEY))
                    .build();
    ...
    private void updateWidgets() {
        ...
        // Setting the package ensures that only components in our com.portfolio.course.esguti.goubiquitous.mobile will receive the broadcast
        ...
        if ( displayNotifications ) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    // In this case, opening the com.portfolio.course.esguti.goubiquitous.mobile is sufficient.
