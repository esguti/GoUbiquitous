package com.portfolio.course.esguti.goubiquitous.mobile.widget;
...
import com.portfolio.course.esguti.goubiquitous.mobile.DetailActivity;
...
public class DetailWidgetProvider extends AppWidgetProvider {
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            // Tell the AppWidgetManager to perform an update on the current com.portfolio.course.esguti.goubiquitous.mobile widget
